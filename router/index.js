...
export const asyncRouterMap = [

  {
    ...
    children: [
      { path: 'plays', component: _import('disney-operate/plays'), name: 'all-plays', meta: { title: '项目开放时间' }},
      { path: 'shows', component: _import('disney-operate/shows'), name: 'all-shows', meta: { title: '演出时间表' }},
    ]
  },
...

  {
    ...
    children: [
      { path: 'plays', component: _import('disney-wait/plays'), name: 'wait-plays', meta: { title: '所有项目' }},
